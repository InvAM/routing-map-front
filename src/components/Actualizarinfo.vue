...
<template>
    <div class="fondo_actualizar">
            ...
            <v-text-field
                ...
                variant="solo"
                rounded="xl"
                placeholder="Ingrese su Año de Graduación">     </v-text-field>
            ...
            <v-select
                class="conolenguajes"
                label="Conocimientos Lenguajes"
                variant="solo"
                chips
                :items="['JavaScript', 'TypeScript', 'React', 'Angular', 'Python', 'Java', 'C++', 'HTML', 'CSS', 'Scala','Vue.js', 'Kotlin','Swift', 'C#']"
                multiple rounded="xl">
            </v-select >
            <v-btn
                density="compact"
