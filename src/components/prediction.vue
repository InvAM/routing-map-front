<template>
    <div class="contenido">
        ...
        <div class="caja1">
            ...
            <v-text-field
                class="participacion"
                label="Participación de Tec"
                variant="solo"
                placeholder="Participación">
            </v-text-field>
            <v-text-field
                class="condicion"
                label="Condición Estudiante"
                variant="solo"
            ...
            <v-select
                ...
                variant="solo"
                chips
                :items="['Trabajo en equipo', 'Comunicación efectiva', 'React', 'Gestión del tiempo', 'Resolución de conflictos', 'Creatividad', 'Adaptabilidad', 'Liderazgo', 'Resolución de problemas', 'Pensamiento crítico', 'Aprendizaje rápido']"
                multiple>
            </v-select>
            <v-text-field
                class="nivel"
            ...
            <v-text-field
                ...
                variant="solo"
                placeholder="Habili Matemáticas">
            </v-text-field>
            <v-text-field
                class="notapromedio"
                label="Nota Promedio"
            ...
            <v-select
                ...
                variant="solo"
                chips
                :items="['JavaScript', 'TypeScript', 'React', 'Angular', 'Python', 'Java', 'C++', 'HTML', 'CSS', 'Vue.js', 'Kotlin', 'C#']"
                multiple>
            </v-select>
            <v-select
                class="interes"
